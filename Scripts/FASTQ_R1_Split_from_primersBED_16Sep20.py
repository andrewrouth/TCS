...
## NOTE: this is super slow in windows environment due to repeated 'append'
## Works well in linux due to fast I/O, but need adjustment if to be run in native windows
